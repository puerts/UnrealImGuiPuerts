...
struct AutoRegisterForDearImGui
{
    AutoRegisterForDearImGui()
    {
    	...
    	puerts::DefineClass<ImFontAtlas>()
            ...
            .Property("CustomRectIds", MakeProperty(&ImFontAtlas::CustomRectIds))
            .Register();
        ...
        puerts::DefineClass<ImGuiIO>()
            ...
            .Property("ConfigWindowsMemoryCompactTimer", MakeProperty(&ImGuiIO::ConfigWindowsMemoryCompactTimer))
        ...
        puerts::DefineClass<ImDrawList>()
            ...
            .Property("_VtxCurrentOffset", MakeProperty(&ImDrawList::_VtxCurrentOffset))
        ...
        puerts::DefineClass<ImFont>()
            ...
            .Property("DisplayOffset", MakeProperty(&ImFont::DisplayOffset))
        ...
        puerts::DefineClass<DearImGui>()
            ...
            .Function("CheckboxFlags", MakeFunction(&ImGui::CheckboxFlags))
            ...
            .Function("DragInt", MakeFunction(&ImGui::DragInt, 1.0f, 0, 0, "%d"))
            .Function("DragInt2", MakeFunction(&ImGui::DragInt2, 1.0f, 0, 0, "%d"))
            .Function("DragInt3", MakeFunction(&ImGui::DragInt3, 1.0f, 0, 0, "%d"))
            .Function("DragInt4", MakeFunction(&ImGui::DragInt4, 1.0f, 0, 0, "%d"))
            .Function("DragIntRange2", MakeFunction(&ImGui::DragIntRange2, 1.0f, 0, 0, "%d", nullptr))
            .Function("DragScalar", MakeFunction(&ImGui::DragScalar, nullptr, nullptr, nullptr, 1.0f)) 
            .Function("DragScalarN", MakeFunction(&ImGui::DragScalarN, nullptr, nullptr, nullptr, 1.0f))
            ...
            .Function("SliderAngle", MakeFunction(&ImGui::SliderAngle, -360.0f, +360.0f, "%.0f deg"))
            .Function("SliderInt", MakeFunction(&ImGui::SliderInt, "%d"))
            .Function("SliderInt2", MakeFunction(&ImGui::SliderInt2, "%d"))
            .Function("SliderInt3", MakeFunction(&ImGui::SliderInt3, "%d"))
            .Function("SliderInt4", MakeFunction(&ImGui::SliderInt4, "%d"))
            ...
            .Function("InputFloat2", CombineOverloads(
                MakeOverloadWithScriptTypePtr(bool (*)(const char*, float [2], const char*, ImGuiInputTextFlags), &ImGui::InputFloat2), //TODO:default value  .Function("InputFloat2", MakeFunction(&ImGui::InputFloat2, "%.3f", 0))
                MakeOverloadWithScriptTypePtr(bool (*)(const char*, float [2], int, ImGuiInputTextFlags), &ImGui::InputFloat2) //TODO:default value  .Function("InputFloat2", MakeFunction(&ImGui::InputFloat2, 0))
                ))
            .Function("InputFloat3", CombineOverloads(
                MakeOverloadWithScriptTypePtr(bool (*)(const char*, float [3], const char*, ImGuiInputTextFlags), &ImGui::InputFloat3), //TODO:default value  .Function("InputFloat3", MakeFunction(&ImGui::InputFloat3, "%.3f", 0))
                MakeOverloadWithScriptTypePtr(bool (*)(const char*, float [3], int, ImGuiInputTextFlags), &ImGui::InputFloat3) //TODO:default value  .Function("InputFloat3", MakeFunction(&ImGui::InputFloat3, 0))
                ))
            .Function("InputFloat4", CombineOverloads(
                MakeOverloadWithScriptTypePtr(bool (*)(const char*, float [4], const char*, ImGuiInputTextFlags), &ImGui::InputFloat4), //TODO:default value  .Function("InputFloat4", MakeFunction(&ImGui::InputFloat4, "%.3f", 0))
                MakeOverloadWithScriptTypePtr(bool (*)(const char*, float [4], int, ImGuiInputTextFlags), &ImGui::InputFloat4) //TODO:default value  .Function("InputFloat4", MakeFunction(&ImGui::InputFloat4, 0))
                ))
            ...
            .Function("ListBoxFooter", MakeFunction(&ImGui::ListBoxFooter))
            ...
            .Function("OpenPopup", MakeFunction(&ImGui::OpenPopup))
            ...
            .Function("BeginPopupContextWindow", MakeFunction(&ImGui::BeginPopupContextWindow, nullptr, 1, true))
